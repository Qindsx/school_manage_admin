<template>
    <el-card header="健康码列表">
        <el-form :inline="true" :model="formData">
            <el-form-item label="姓名">
                <el-input v-model="formData.health_name" placeholder="输入姓名查询"></el-input>
            </el-form-item>
            <el-form-item label="手机号">
                <el-input v-model="formData.phone" placeholder="输入手机号查询"></el-input>
            </el-form-item>
            <el-form-item label="学号工号">
                <el-input v-model="formData.student_number" placeholder="输入学号工号查询"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" :icon="Search" @click="handleSerch">查询</el-button>
            </el-form-item>
            <el-form-item>
                <download-excel lass="export-excel-wrapper" :data="json_data" :name="dwtjsjName"
                    :before-generate="startDownload" :fields="json_fields">
                    <el-button @click="hadnleExport" type="warning" icon="download" style="margin-left: 100%">导出数据
                    </el-button>
                </download-excel>
            </el-form-item>
        </el-form>
        ...
        <el-table max-height="550" border stripe :data="listData">
            ...
            <el-table-column label="核酸检测结果" prop="nucleic_acid_result"></el-table-column>
            <el-table-column label="核酸检测时间" prop="nucleic_acid_time"></el-table-column>
    ...
    methods: {
        ...
        async hadnleExport() {
            ...
            if (res.data) {
                ...
                writeFile(workBook, '健康码异常信息报表.xlsx');
